...
Tasks: mark S/V/O in sentences 1, 4, 7; mark nouns/articles/modals; order five process steps; write three frame-based sentences; read aloud 20–30 seconds and answer one question bằng frame. Không yêu cầu retell 60 giây.
...
Tasks: first-pass main idea; second pass max 8 terms; mark passives/connectors/clauses; six-keyword notes; 3-sentence summary; explanation 45–60 giây theo frame; name one limitation of checking only file existence.
...
Tasks: map B–P–M–R–C; mark numbers and hedging; five simple-English sentences theo move map; talk tối đa 90 giây; explain the reliability/cost trade-off.
...
Tasks: paragraph map; identify problem, mechanism, design and limitation; 8-keyword notes; talk 2–3 phút; answer five questions about test reuse, suite types, hidden set, repeated runs and human review.
...
Tasks: first pass 20 minutes; topic/purpose/main idea; annotate problem, mechanism, benefit and limitation; mark connectors, passive and hedging; paraphrase five key sentences; 8-keyword PREML talk 2–3 phút; answer five follow-ups.
