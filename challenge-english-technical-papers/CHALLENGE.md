...
Từ mức tự báo cáo band 1.0, sau 30 buổi bạn có thể đọc có chiến lược một đoạn technical English/paper, nhận ra vấn đề–phương pháp–kết quả–giới hạn, rồi trình bày lại bằng tiếng Anh đơn giản và dễ hiểu. Đây không phải cam kết đạt một IELTS band cụ thể hoặc đọc mọi paper hoàn toàn độc lập trong 30 ngày.
...
Không có nguồn dưới đây xác lập một con số phút/ngày tối ưu phổ quát cho người học tiếng Anh band 1.0. Nghiên cứu ủng hộ mạnh hơn cho **cách phân bổ và chất lượng luyện tập** so với việc tăng tổng số giờ:

1. Meta-analysis của Cepeda và cộng sự tổng hợp 839 phép đánh giá từ 317 thí nghiệm cho thấy khoảng cách giữa các lần học và thời gian cần ghi nhớ tương tác với nhau; vì vậy không thể suy ra một thời lượng buổi học cố định cho mọi mục tiêu ([Cepeda et al., 2006](https://doi.org/10.1037/0033-2909.132.3.354)).
2. Trong học từ vựng ngoại ngữ, cùng 30 phút nhưng chia thành ba buổi 10 phút ở ba ngày cho retention sau bốn ngày cao hơn 35% so với học dồn một lần; đây là bằng chứng trực tiếp để ưu tiên distributed practice thay vì nhồi giờ ([Bloom & Shuell, 1981](https://doi.org/10.1080/00220671.1981.10885317)).
...
- 30 buổi hoàn thành; thời lượng tuân theo workload đã đóng băng ở trên.
- Chủ đề ưu tiên: AI, agent, machine learning và system design.
- Graded corpus và mini-paper nguyên bản đã khóa trong `EXERCISES.md` và `PRACTICE_PAPER.md`.
- Hai tài liệu `ai-agent-system-design-exam.pdf` và `de-luyen-tap.md` chỉ dùng làm transfer corpus sau khi đã qua graded passage.
- Paper riêng của bạn là transfer test tùy chọn từ Ngày 29, không còn là dependency để hoàn thành challenge.
...
- Học câu/chunks, không học từ đơn rời rạc.
...
Không học bù gấp đôi. Sau ngày bỏ lỡ, làm minimum của ngày hiện tại và chuyển phần stretch vào backlog. Chỉ thay kế hoạch tương lai; không sửa evidence cũ.
